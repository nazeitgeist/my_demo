<template>
    <div>
        <h4 class="text-center">Edit Developer</h4>
        <div class="row">
            <div class="col-md-12">
...
export default {
    ...
    created() {
        this.$axios.get('/sanctum/csrf-cookie').then(response => {
            this.$axios.get(`/api/developers/edit/${this.$route.params.id}`)
                .then(response => {
    ...
    methods: {
        updateDeveloper() {
            ...
            this.$axios.get('/sanctum/csrf-cookie').then(response => {
                this.$axios.post(`/api/developers/update/${this.$route.params.id}`, formData, config)
                    .then(response => {
